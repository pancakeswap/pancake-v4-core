...
contract BinPoolSwapTest is BinTestHelper {
    ...
    function testFuzz_SwapInForY(uint128 amountOut) public {
        ...
        assertEq(vault.balanceDeltaOfPool(key).amount0(), -int128(amountIn), "TestFuzz_SwapInForY::2");
        assertEq(vault.balanceDeltaOfPool(key).amount1(), int128(amountOut), "TestFuzz_SwapInForY::3");
    }
    ...
    function testFuzz_SwapInForX(uint128 amountOut) public {
        ...
        // verify .getSwapIn match with swap result
        assertEq(vault.balanceDeltaOfPool(key).amount0(), int128(amountOut), "TestFuzz_SwapInForX::2");
        assertEq(vault.balanceDeltaOfPool(key).amount1(), -int128(amountIn), "TestFuzz_SwapInForX::3");
    }
    ...
    function testFuzz_SwapOutForY(uint128 amountIn) public {
        ...
        // verify .getSwapIn match with swap result
        assertEq(vault.balanceDeltaOfPool(key).amount0(), -int128(amountIn), "TestFuzz_SwapOutForY::2");
        assertEq(vault.balanceDeltaOfPool(key).amount1(), int128(amountOut), "TestFuzz_SwapOutForY::3");
    }
    ...
    function testFuzz_SwapOutForX(uint128 amountIn) public {
        ...
        // verify .getSwapIn match with swap result
        assertEq(vault.balanceDeltaOfPool(key).amount0(), int128(amountOut), "TestFuzz_SwapOutForY::2");
        assertEq(vault.balanceDeltaOfPool(key).amount1(), -int128(amountIn), "TestFuzz_SwapOutForY::3");
    }
